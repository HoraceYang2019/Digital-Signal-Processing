...
class PlotCanvas(FigureCanvas):
    def __init__(self, parent=None, width=9.5, height=7, dpi=100): 
        #第一步：建立一個建立Figure
...
class MainUi(QtWidgets.QMainWindow, MainWindow):
    def __init__(self, *args, **kwargs):
        ...
        self.gvOverview.setScene(graphicscene)  #將建立新增到圖形檢視顯示視窗
        self.gvOverview.show()
